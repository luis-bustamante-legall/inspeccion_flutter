...
class RestRepository {
  ...
  Future<void> updateScheduleRest(InspectionModel inspectionModel) async {
    ...
    final fecha = inspectionModel.schedule[inspectionModel.schedule.length-1].dateTime.toString();
    Map<String, dynamic> body = {
      "idInforme": "${inspectionModel.informeId}",
      "usuarioCreacion": "ADMIN",
      "fechaProgramada":"${fecha.substring(0,10)}T${fecha.substring(11,19)}"
      //"2021-04-21T12:20:00"
      //inspectionModel.schedule[inspectionModel.schedule.length-1].dateTime.toString()
    };
